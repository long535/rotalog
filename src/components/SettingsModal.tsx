...
export default function SettingsModal({ settings, onSave, onClose, jobs = [], onAddJob, onUpdateJob, onDeleteJob, onSetDefaultJob, onExport, onImport }: Props) {
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5 custom-scrollbar">
          ...
          <section>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-slate-700 text-sm">{t.defaultWage}</span>
              </div>
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  className="w-16 p-1.5 bg-slate-50 rounded-lg text-right font-medium text-slate-700 outline-none text-sm"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-yellow-500/10 flex items-center justify-center">
                  <span className="material-symbols-outlined text-yellow-600 text-lg">attach_money</span>
                </div>
                <span className="font-medium text-slate-700 text-sm">{t.currency}</span>
              </div>
              <input
                type="text"
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-purple-500/10 flex items-center justify-center">
                  <span className="material-symbols-outlined text-purple-500 text-lg">coffee</span>
                </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-cyan-500/10 flex items-center justify-center">
                  <span className="material-symbols-outlined text-cyan-500 text-lg">calendar_today</span>
                </div>
          ...
          <section>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-[var(--color-primary)]/10 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--color-primary)] text-lg">palette</span>
                </div>
          ...
          <section>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-[var(--color-primary)]/10 flex items-center justify-center">
                  <span className="material-symbols-outlined text-[var(--color-primary)] text-lg">calculate</span>
                </div>
                <div>
            ...
            {showJobForm && (
              <div className="mb-3 p-3 bg-slate-50 rounded-xl border border-slate-100">
                <input
                  ...
                  className="w-full p-2 mb-2 bg-white rounded-lg text-slate-800 outline-none text-sm"
                />
